...
namespace DAL
{
    public class quanLyLoaiTraiCayDAL:DBAccess
    {
        ...
        public bool CapNhatloaiTraiCay(quanLyLoaiTraiCay quanLyLoaiTraiCaycapnhat)
        {
            SqlConnection conn = sqlConnecTionData.connect();
            conn.Open();
            SqlCommand command = new SqlCommand("UPDATE quanLyLoaiTraiCay SET tenLoaiTraiCay=@tenLoaiTraiCay,trangThai=@trangThai Where id=@id", conn);
        ...
        public List<quanLyLoaiTraiCay> TimkiemloaiTraiCay(int idloaiTraiCay)
        {
            ...
            SqlConnection conn = sqlConnecTionData.connect();
            conn.Open();
            SqlCommand command = new SqlCommand("SELECT * FROM quanLyLoaiTraiCay Where id = @id", conn);
